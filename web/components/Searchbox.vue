  ...
  <div>
            ...
            <div class="column is-centered is-half is-narrow">
              ...
              <form @submit="onSubmit">
                <div class="field has-addons">
                  ...
                  <div class="control">
                    <button
                      class="submitButton is-focus is hover"
                      type="submit"
                    >
                      <img
    ...
    <section class="section">
      <div class="columns is-multiline">
        <Result v-for="meme in memes" :key="meme.id" :meme="meme" />
      </div>
    </section>
  </div>
</template>
...
export default {
  ...
  methods: {
    onFileSelected(event) {
      ...
      this.$axios
        .$post(process.env.SERVER_URL + '/api/ai/upload', fd)
        .then((res) => {
    ...
    onSubmit(event) {
      ...
      this.$axios
        .$post(process.env.SERVER_URL + '/api/ai/search', {
          search: this.search,
        })
        .then((res) => {
          this.memes = res.output.reverse()
